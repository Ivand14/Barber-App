...
import verifyLogin from '../../Redux/action/Login/verifyLoginAction'
...
const LoginToken = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if (Object.keys(validateErrors).length === 0) {
            dispatch(verifyLogin(form.email,form.password));
            setForm({
                email:'',
                password:''
            });
    ...
    return (
        ...
        >
            ...
            >
                <Typography sx={{fontSize:40,color:'white',fontWeight:900}}>Confirmacion de cuenta</Typography>
                <Typography sx={{fontSize:20,color:'white'}}>Confirma tu cuenta para iniciar sesión</Typography>
